...
public partial class StudentManagementContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ClassDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.HomeroomTeacher).WithMany(p => p.ClassDetails).HasConstraintName("FK_ClassDetail_Teachers1");

            entity.HasOne(d => d.HomeroomTeacherNavigation).WithMany(p => p.ClassDetails).HasConstraintName("FK_ClassDetail_Teachers");
        });
        ...
        {
            entity.HasOne(d => d.HomeroomTeacherNameNavigation).WithMany(p => p.HomeroomTeachers).HasConstraintName("FK_HomeroomTeacher_Users");
        });
